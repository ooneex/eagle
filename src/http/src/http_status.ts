/**
 * Represents HTTP status codes and their corresponding numeric values.
 */
...
export const STATUS_CODE_TEXT = {
  ...
  [STATUS_CODE.RequestURITooLong]: "Request URI Too Long",
  [STATUS_CODE.RequestedRangeNotSatisfiable]: "Requested Range Not Satisfiable",
